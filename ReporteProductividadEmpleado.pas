unit ReporteProductividadEmpleado;
...
var
  frmProdEmpleado: TfrmProdEmpleado;
  Conn : TADOConnection;
  Qry : TADOQuery;
...
procedure TfrmProdEmpleado.FormCreate(Sender: TObject);
begin
...
procedure TfrmProdEmpleado.BindProductos();
var Qry2 : TADOQuery;
SQLStr : String;
begin
...
procedure TfrmProdEmpleado.BindEmpleados();
var Qry2 : TADOQuery;
SQLStr : String;
begin
    Qry2 := TADOQuery.Create(nil);
...
procedure TfrmProdEmpleado.BindClientes();
var Qry2 : TADOQuery;
SQLStr : String;
...
procedure TfrmProdEmpleado.BindTareas();
var Qry2 : TADOQuery;
SQLStr : String;
begin
    Qry2 := TADOQuery.Create(nil);
...
procedure TfrmProdEmpleado.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
        Action := caFree;
end;

procedure TfrmProdEmpleado.btnDescClick(Sender: TObject);
begin
...
procedure TfrmProdEmpleado.btnClientesClick(Sender: TObject);
begin
...
procedure TfrmProdEmpleado.ShowSeleccionGrid(GroupBox: TGroupBox; CheckBox: TCheckBox;
...
procedure TfrmProdEmpleado.Button7Click(Sender: TObject);
begin
  gbDesc.Visible := False;
  gbClientes.Visible := False;
  gbEmpleados.Visible := False;  
...
procedure TfrmProdEmpleado.btnClientesOKClick(Sender: TObject);
begin
  ParseSelection(gbClientes,chkClientes,txtCliente,gvClientes);
end;

procedure TfrmProdEmpleado.chkClientesClick(Sender: TObject);
begin
  gvClientes.Enabled := not chkClientes.Checked;
  btnTodosClientes.Enabled := not chkClientes.Checked;
end;

procedure TfrmProdEmpleado.btnTodosClientesClick(Sender: TObject);
begin
  SelectOrUnselectAll(btnTodosClientes, gvClientes);
end;

procedure TfrmProdEmpleado.btnDescOKClick(Sender: TObject);
begin
  ParseSelection(gbDesc,chkDesc,txtProducto,gvDescs);
end;

procedure TfrmProdEmpleado.chkDescClick(Sender: TObject);
begin
  gvDescs.Enabled := not chkDesc.Checked;
  btnTodosDesc.Enabled := not chkDesc.Checked;
end;

procedure TfrmProdEmpleado.btnTodosDescClick(Sender: TObject);
begin
  SelectOrUnselectAll(btnTodosDesc, gvDescs);
end;

procedure TfrmProdEmpleado.btnTareasOKClick(Sender: TObject);
begin
  ParseSelection(gbTareas,chkTareas,txtTareas,gvTareas);
end;

procedure TfrmProdEmpleado.chkTareasClick(Sender: TObject);
begin
  gvTareas.Enabled := not chkTareas.Checked;
  btnTodosTareas.Enabled := not chkTareas.Checked;
end;

procedure TfrmProdEmpleado.btnTodosTareasClick(Sender: TObject);
begin
  SelectOrUnselectAll(btnTodosTareas, gvTareas);
end;

procedure TfrmProdEmpleado.ParseSelection(GroupBox: TGroupBox; CheckBox: TCheckBox; TextBox: TEdit; Grid: TGridView);
var i: integer;
sOrdenes : String;
begin
  GroupBox.Visible := False;
...
procedure TfrmProdEmpleado.SelectOrUnselectAll(Button: TButton; Grid:TGridView);
var i: integer;
begin
...
procedure TfrmProdEmpleado.ExportGrid(Grid: TGridView;sFileName: String);
const
  xlWorkSheet = -4167;
var XApp : Variant;
Sheet : Variant;
...
procedure TfrmProdEmpleado.Exportar1Click(Sender: TObject);
...
function TfrmProdEmpleado.getWhere():String;
var SQLWhere: String;
begin
...
procedure TfrmProdEmpleado.btnBuscarClick(Sender: TObject);
var SQLStr : String;
i:integer;
begin
    ...
    SQLStr := 'Productividad_Empleado ' + QuotedStr(getWhere());
...
procedure TfrmProdEmpleado.BindGridAuto(SQLStr: String;  Grid:TGridView);
var Qry2 : TADOQuery;
...
procedure TfrmProdEmpleado.Button1Click(Sender: TObject);
begin
  gbDesc.Visible := False;
  gbClientes.Visible := False;
  gbTareas.Visible := False;
...
procedure TfrmProdEmpleado.btnEmpleadosOKClick(Sender: TObject);
begin
  ParseSelection(gbEmpleados,chkEmpleados,txtEmpleados,gvEmpleados);
end;

procedure TfrmProdEmpleado.chkEmpleadosClick(Sender: TObject);
begin
  gvEmpleados.Enabled := not chkEmpleados.Checked;
  btnTodosEmpleados.Enabled := not chkEmpleados.Checked;
end;

procedure TfrmProdEmpleado.btnTodosEmpleadosClick(Sender: TObject);
begin
