...
begin
      ...
      //Sheet.Name := 'Ordenes de Compra';
      Sheet.Cells[5, 3] := cmbCompra.Text;
      for Row := 1 to Grid.RowCount do begin
        Sheet.Cells[Row + 7, 1] := Grid.Cells[0, Row - 1];
        Sheet.Cells[Row + 7, 2] := Grid.Cells[1, Row - 1];
        //Sheet.Cells[Row + 7, 3] := Grid.Cells[1, Row - 1];
        Sheet.Cells[Row + 7, 4] := Grid.Cells[4, Row - 1];
        Sheet.Cells[Row + 7, 5] := Grid.Cells[5, Row - 1];
        Sheet.Cells[Row + 7, 6] := Grid.Cells[7, Row - 1];
        //Sheet.Cells[Row + 7, 7] := Grid.Cells[4, Row - 1];
