...
begin
    ...
    Begin
        ...
        GridView2.Cells[14,GridView2.RowCount -1] := VarToStr(Qry['RET_Detectado']);
        GridView2.Cells[15,GridView2.RowCount -1] := VarToStr(Qry['EmpleadoDetectado']);
        GridView2.Cells[16,GridView2.RowCount -1] := VarToStr(Qry['RET_Motivo']);
        Qry.Next;
    End;
